...
public class _11_Integer {
	...
	public static void main(String[] args) {
		...
		//int 의 최대값, 최소값을 상수인 멤버변수로 지정해놔서
		//멤버년수를 호출하면 확인가능하다. 
		...
		//사이즈, 바이트, 타입 확인
	    System.out.println("size는 " + num1.SIZE);
	    System.out.println("bytes는 " + num1.BYTES);
	    System.out.println("type은 " + num1.TYPE);
	    
	    //문자열을 정수형으로 변환
	    //System.out.println(Integer.parseInt("FF"));
	    System.out.println(Integer.parseInt("FF", 16)); //16진수로 표현행
	}
